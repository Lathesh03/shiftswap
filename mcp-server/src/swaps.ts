// Copied from ../../lib/swaps.ts — see the project README's note on why
// this is duplicated into the MCP server rather than imported cross-project.
import type { SwapEvent, SwapState, SwapStatus, Result } from "./types.js";
